...
## Least number of notes to be given on form in 1,2,5,10,100,500,2000 currency amount
def least_notes():
    try:
    ...
    if amount == 0:
        ...
        if reminder_d_2000 % 500 == 0:
            ...
            if reminder_d_500 % 100 == 0:
                notes = reminder_d_500 / 100
                print(f"Number of 2000rs Notes: {new_2000_notes}\nNumber of 500rs Notes: {new_500_notes}\nNumber of 100rs Notes: {notes}")
                print(f"Total Number of Notes: {new_2000_notes + new_500_notes + notes}")
            elif reminder_d_500 % 100 != 0:
                reminder_d_100 = reminder_d_500 % 100
                amount_left = reminder_d_500 - reminder_d_100
                notes_100 = amount_left / 100
                if reminder_d_100 % 50 == 0:
                    notes_50 = reminder_d_100 / 50
                    print(f"Number of 2000rs Notes: {new_2000_notes}\nNumber of 500 Notes: {new_500_notes}\nNumber of 100 Notes: {notes_100}")
                    print(f"number of 50 Notes: {notes_50}\nTotal Number: {new_2000_notes + new_500_notes + notes_100 + notes_50}")
                    ...
                    if reminder_d_50 % 10 == 0:
                        ...
                        print(f"Number of 2000rs Notes: {new_2000_notes}")
                        print(f"Number of 500rs Notes: {new_500_notes}\nNumber of 100rs Notes: {notes_100}\n")
                        print(f"Number of 50rs Notes: {new_50_notes}\nNumber of 10rs Notes: {notes_10}\n")
                        print(f"Total Notes: {new_2000_notes + new_500_notes + notes_100 + new_50_notes + notes_10}")
                        ...
                        if reminder_d_10 % 5 == 0:
                            ...
                            print(f"Number of 2000rs Notes: {new_2000_notes}")
                            print(f"Number of 500rs Notes: {new_500_notes}\nNumber of 100rs Notes: {notes_100}")
                            print(f"Number of 50rs Notes {new_50_notes}\nNumber of 10rs Notes: {new_10_notes}")
                            print(f"Number of 5 Notes: {notes_5}\nTotal Notes: {new_2000_notes + new_500_notes + notes_100 + new_50_notes + new_10_notes + notes_5}")
                            ...
                            if reminder_d_5 % 2 == 0:
                                ...
                                print(f"Total Notes: {new_2000_notes + new_500_notes + notes_100 + new_50_notes + new_10_notes + new_5_notes + notes_2}")
                                ...
                                print(f"Total Notes: {new_2000_notes + new_500_notes + notes_100 + new_50_notes + new_10_notes + new_5_notes + new_2_notes + notes_1}")
if __name__ == '__main__':
    print("Welcome!\nThis Program Gives U Least Number of Indian Currency Notes To Give\nIn form of 1rs, 2rs, 5rs, 10rs, 100rs, 500rs, 2000rs\n")
    least_notes()
